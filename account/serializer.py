...
class CarSerializer(serializers.ModelSerializer):
    class Meta:
        model = Car
        fields = ("name", "country", "owner", "color")


class CarDetailSerializer(serializers.ModelSerializer):
    class Meta:
        model = Car
        fields = ("name", "country", "owner", "color", "company", "asd", "year", "automatic_box")


class CarCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Car
        fields = ("owner", "company", "year")


class CarChangeColorSerializer(serializers.ModelSerializer):
    class Meta:
        model = Car
        fields = ("color", )
